...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtTotalHeuresRayon.setEditable(false);
    ...
    private void tblSecteursMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSecteursMouseClicked
            while(tblRayons.getRowCount() != 0)
            {
                dtmRayons.removeRow(0);
            }
            
            if(tblSecteurs.getSelectedRowCount() == 1)
            {
                int idSecteur = Integer.parseInt(tblSecteurs.getValueAt(tblSecteurs.getSelectedRow(), 0).toString());
                for(Rayon r:fm.GetAllRayonsByIdsecteur(idSecteur))
                {
                    v = new Vector();
                    v.add(r.getIdRayon());
                    v.add(r.getNomRayon());
    ...
    private void tblRayonsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRayonsMouseClicked
            while(tblEmployes.getRowCount() != 0)
            {
                dtmEmployes.removeRow(0);
            }
            
            if(tblRayons.getSelectedRowCount() == 1)
            {
                int numRayon = Integer.parseInt(tblRayons.getValueAt(tblRayons.getSelectedRow(), 0).toString());
                for(Travailler t:fm.GetAllTravailler(numRayon))
                {
                    v = new Vector();
                ...
                txtTotalHeuresRayon.setText(String.valueOf(fm.TotalHeuresRayon(numRayon)));
            }
            else
            {
                txtTotalHeuresRayon.setText("");
            }
        
    }//GEN-LAST:event_tblRayonsMouseClicked

    private void btnModifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModifierMouseClicked
        if(tblEmployes.getSelectedRowCount() != 1)
        {
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un seul employé");
        }
        else if(txtNouveauTemps.getText().compareTo("")==0)
        {
            JOptionPane.showMessageDialog(this, "Veuillez saisir un nouveau temps");
        }
        else
        {
            fm.ModifierTemps(Integer.parseInt(tblEmployes.getValueAt(tblEmployes.getSelectedRow(), 0).toString()), Integer.parseInt(tblRayons.getValueAt(tblRayons.getSelectedRow(), 0).toString()), tblEmployes.getValueAt(tblEmployes.getSelectedRow(), 2).toString(), Integer.parseInt(txtNouveauTemps.getText()));
            while(tblEmployes.getRowCount() != 0)
            {
                dtmEmployes.removeRow(0);
            }
    ...
    private void btnInsererTempsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInsererTempsMouseClicked
        if(tblRayons.getSelectedRowCount() != 1)
        {
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un seul rayon");
        }
        else if(txtNouveauTemps.getText().compareTo("")==0)
        {
            JOptionPane.showMessageDialog(this, "Veuillez ajouter un nouveau temps");
        }
        else
        {
            int codeEmploye = fm.GetIdEmployeByNom(cboEmployes.getSelectedItem().toString());
            int codeRayon = Integer.parseInt(tblRayons.getValueAt(tblRayons.getSelectedRow(), 0).toString());
            fm.InsererTemps(codeEmploye, codeRayon, Integer.parseInt(txtNouveauTemps.getText()));
            while(tblEmployes.getRowCount() != 0)
            {
                dtmEmployes.removeRow(0);
            }
